...
export default function HeatIslandReportLayout() {
  ...
  return (
    <div ref={containerRef} id="data-section" data-section="data" className="min-h-screen bg-[#1a1d1f] text-text-secondary font-chinese">
      ...
      <section className="relative px-6 py-16 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-2xl font-medium text-accent mb-4">一年比一年更熱的現實</h2>
      ...
      <section className="relative px-6 py-24 max-w-7xl mx-auto">
        <div className="relative flex items-center justify-between">
          ...
          <div className="relative z-10 w-1/2 pr-8">
            {/* 第一段文字 */}
            <motion.div
              className="mb-12 p-8 bg-[#1a1d1f]/65 backdrop-blur-sm rounded-lg"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, margin: '-100px' }}
              variants={slideIn}
              transition={{ delay: 0.3 }}
            >
              <h2 className="text-2xl font-medium text-accent mb-4">日夜溫差的悄然收斂</h2>
              <p className="text-lg leading-relaxed text-justify">
            ...
            >
              <h3 className="text-xl font-medium text-accent mb-4">綠覆與海風：微妙的降溫之道</h3>
              <p className="text-lg leading-relaxed text-justify">
          ...
          {/* 右側圖片 */}
          <motion.div
            className="absolute right-0 top-1/2 -translate-y-1/2 w-[45%] z-0"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, margin: '-100px' }}
            variants={slideIn}
          ...
          >
            <div className="w-full aspect-[4/3] rounded-lg overflow-hidden shadow-2xl">
              <Image
